...
const Details = props => {
  return (
    ...
    <div className="modal fade bd-example-modal-lg bg-light" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div className="modal-dialog modal-lg">
        <div classNamee="modal-content">
          <div className="modal-header bgCustom">
